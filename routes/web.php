...
Route::get('get-subcategories/{category_id}', 'SubcategoryController@getSubcategories');

// sub sub category routes
Route::resource('manage-sub-subcategory', 'SubsubcategoryController');
Route::put('change-sub-subcategory-status/{id}/{status}', 'SubsubcategoryController@changestatus');
...
Route::post('fetch-subsubcategory-by-subcategory', 'PostController@fetchSubSubcategoryBySubcategory');
