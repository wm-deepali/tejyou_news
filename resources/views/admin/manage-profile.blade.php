                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-block">
                            <form class="form-body" method="POST" action="{{ route('update-profile') }}"
                                            ...
                                            <div class="col-sm-12">
                                                @if (isset($user->image))
                                                    <img src="{{ URL::asset('storage/' . $user->image) }}"
                                                        class="img-fluid img-stud-pro">
                                                @else
                                                    <img src="{{ URL::asset('admin/images/usr.png') }}"
                                                        class="img-fluid img-stud-pro">
                                                @endif
                                            </div>
                                            <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" class="text-control" placeholder="Enter Mobile No."
                                                    name="contact" value="{{ $user->contact }}">
                                            </div>
                                            <div class="col-sm-6">
                                                <label class="label label-control">Address</label>
                                                <input type="text" class="text-control" placeholder="Enter Address"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <label class="label label-control">Bio / Introduction</label>
                                                <textarea class="text-control"
                                                    placeholder="Write a short bio or introduction" name="bio"
                        ...
                        <div class="card-block">
                            <form action="{{ route('update-profile-password') }}" method="POST">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label class="label-control">New Password <span
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label class="label-control">Re-enter Password <span
                                                    class="required">*</span></label>
