      ...
      <form id="add-subcategory-form">
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            ...
            <label><input type="checkbox" name="hassubsubcategory" value="yes" id="hassubsubcategory"> Has Sub Sub
              Category</label><br>
            <label><input type="checkbox" name="showonheader" value="yes" id="showonheader"> Show on Header</label>
          </div>
          <div class="col-sm-6">
