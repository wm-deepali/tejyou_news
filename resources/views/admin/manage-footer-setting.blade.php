            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    <div class="content-header">
                        ...
                        <button class="btn btn-dark btn-save" type="submit"><i class="fas fa-plus"></i> Update
                            Settings</button>
                        <ol class="breadcrumb">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    @if (isset($footer->image) && Storage::exists($footer->image))
                                                        <img src="{{ URL::asset('storage/' . $footer->image) }}"
                                                            class="img-fluid" style="height: 40px;">
                                                    @endif
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="label label-control">Logo Link</label>
                                                    <input type="text" class="text-control" placeholder="Logo Link"
                                                        value="{{ old('link', $footer->link ?? null) }}" name="link">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text"
                                                        value="{{ old('content', $footer->content ?? null) }}"
                                                        placeholder="Enter Copyright Text" class="text-control"
                                                        name="content">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card-body">
                            <div class="card-block">
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label class="label-control">Facebook <span
                                                    class="required">*</span></label>
                                            <input type="text" class="text-control" placeholder="Enter Facebook URL"
                                                value="{{ old('facebook', $footer->facebook ?? null) }}" name="facebook">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label class="label-control">Twitter <span class="required">*</span></label>
                                            <input type="text" class="text-control" placeholder="Enter Twitter URL"
                                                value="{{ old('twitter', $footer->twitter ?? null) }}" name="twitter">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label class="label-control">RSS <span class="required">*</span></label>
                                            <input type="text" class="text-control" placeholder="Enter RSS URL"
                                                value="{{ old('rss', $footer->rss ?? null) }}" name="rss">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label class="label-control">YouTube</label>
                                            <input type="text" class="text-control" placeholder="Enter YouTube URL"
                                                value="{{ old('youtube', $footer->youtube ?? null) }}" name="youtube">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" class="text-control"
                                                ...
                                                value="{{ old('whatsapp', $footer->whatsapp ?? null) }}"
                                                name="whatsapp">
                                        </div>
                                    </div>
