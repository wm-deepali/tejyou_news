                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea name="content1" id="content1" cols="30" rows="10"
                                                        class="form-control">{{ old('content1', $aboutus->content1 ?? null) }}</textarea>
                                                    @error('content1')
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea name="content2" id="content2" cols="30" rows="10"
                                                        class="form-control">{{ old('content2', $aboutus->content2 ?? null) }}</textarea>
                                                    @error('content2')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea name="address" id="address" cols="30" rows="10"
                                                        class="form-control">{{ old('address', $aboutus->address ?? null) }}</textarea>
                                                    @error('address')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="contact1" class="form-control"
                                                        value="{{ old('contact1', $aboutus->contact1 ?? null) }}">
                                                    @error('contact1')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="contact2" class="form-control"
                                                        value="{{ old('contact2', $aboutus->contact2 ?? null) }}">
                                                    @error('contact2')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="email" name="email" class="form-control"
                                                        value="{{ old('email', $aboutus->email ?? null) }}">
                                                    @error('email')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" name="map" class="form-control"
                                                        value="{{ old('map', $aboutus->map ?? null) }}">
                                                    @error('map')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
