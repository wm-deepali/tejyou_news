...
<form method="POST" action="{{ route('update-terms-of-use') }}" enctype="multipart/form-data">
@csrf
                    ...
                    <div class="card-body">
                        <div class="card-block">
                            <form class="form-body">
                                <h4 class="form-section-h">Update Terms of use</h4>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <label class="label label-control">Content</label>
                                                <textarea name="content" id="content" cols="30" rows="10" class="form-control">{{ old('content',$termsofuse->content ?? null) }}</textarea>
                                                @error('content')
