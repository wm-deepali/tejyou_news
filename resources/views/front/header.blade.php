                                ...
                                <li><i class="fa fa-clock-o"></i> Last Update 11:30 am</li>
                                 <li>|</li>
                                  <li><a href="{{ route('e-paper') }}"><button
                                                    class="login-btn"> <i class="fa-regular fa-newspaper"></i> ई-पेपर</button></a></li>
                                                    <li>|</li>
                                <li> राजनीति</li>
                                 <li>|</li>
                                <li> टेक्नोलॉजी</li> 
...
<div id="sidebarOverlay" class="sidebar-overlay"></div>
                                ...
                                <!--<li><i class="fa fa-cloud"></i> 29°C Greater Noida</li>-->
...
<div id="newLeftSidebar" class="new-left-sidebar">
    ...
    <nav class="new-sidebar-nav">
        <ul class="new-menu-list">
            ...
            <li>
                <a href="#"><i class="fa-solid fa-users"></i> Our Reporters</a>
            </li>

            <li>
                <a href="#"><i class="fa-solid fa-info-circle"></i> About Us</a>
            </li>

            <li>
                <a href="#"><i class="fa-solid fa-user-tie"></i> Our Team</a>
            </li>
                        ...
                        <div class="container">
                            <nav>
                                <ul class="news5-nav">
                                    ...
                                    <li><a href="{{ route('e-paper') }}"><button
                                                    class="login-btn" style="color:#fff; font-weight:600;font-size:16px;"> <i class="fa-regular fa-newspaper"></i> ई-पेपर</button></a></li>
                                                    <li style="color:#fff; font-weight:600;">|</li>
                                                    <li>
                                                        <button type="button" class="jt-search-btn open-search"><i class="fa fa-search"></i></button>
  ...
  <div class="jt-modal-content">
    ...
    <div class="jt-tags">
      ...
      <span>बॉलीवुड</span>
                        ...
                        <!--<div class="submenu-right-section">-->
                        <!--   <div class=" text-right">-->
                        <!--        <div class="header-action-item">-->
                        <!--            <ul class="" style="display:flex; gap:15px; align-items:center;">-->
                                        <!--<li>-->
